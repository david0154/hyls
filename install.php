...
";
        ...
        // Create logo and favicon placeholders
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="site_description" placeholder="Professional Link Shortener and Bio Link Platform"></textarea>
            </div>

            <div class="form-group">
                <label>Site Keywords</label>
                <input type="text" name="site_keywords" placeholder="link shortener, bio link, url shortener">
            </div>
